...
class Silentarmy:
    ...
    def update_mining_job(self):
        ...
        if not self.st_had_job:
            ...
            l = len(self.opts.use)
            print('VerusCoin miner by Monkins1010, Mining on %d device%s' % (l, '' if l == 1 else 's'))
...
def main():
    ...
    parser.add_option(
            ...
            default='stratum+tcp://stratum.veruspool.xyz:9999',
    ...
    parser.add_option(
            ...
            default="REoPcdGXthL5yeTCrJtrQv5xhYTknbFbec.monkins",
